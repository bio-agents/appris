...
pack [frame .tk-R.agentbar] -anchor n -fill x
...
# pack [frame .tk-R.agentbar.stop -container true] -side right
# set stopscript $env(R_HOME)/library/tcltk/exec/stopit.tcl 
# update
# exec wish -use [winfo id .tk-R.agentbar.stop] < $stopscript [pid] &
