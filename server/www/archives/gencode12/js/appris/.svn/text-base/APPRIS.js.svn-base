...
APPRIS.RESTWS = "../../ws/rel12/rest/";
APPRIS.RELEASE_URL = "http://appris.bioinfo.cnio.es/archives/gencode12/";
...
APPRIS.API_VERSION = "rel12";
APPRIS.VERSION = "26Mar2013.v4.2";
APPRIS.RELEASE_TITLE = "APPRIS/Gencode12 - release 4 - Mar 2012";
APPRIS.PERL_API_FILE = "<a href='../download/api/appris.perl-api.rel12.v4.tar.gz'>http://appris.bioinfo.cnio.es/download/api/appris.perl-api.rel12.v4.tar.gz</a>";

APPRIS.ENSEMBL_URL = "http://may2012.archive.ensembl.org/Homo_sapiens/Transcript/Summary?db=core";
...
APPRIS.MYSQL_FILE_E = "appris.entity.homo_sapiens_gencode_12."+APPRIS.VERSION+".dump.gz";
APPRIS.MYSQL_FILE_F = "appris.firestar.homo_sapiens_gencode_12."+APPRIS.VERSION+".dump.gz";
APPRIS.MYSQL_FILE_M = "appris.matador3d.homo_sapiens_gencode_12."+APPRIS.VERSION+".dump.gz";
APPRIS.MYSQL_FILE_C = "appris.corsair.homo_sapiens_gencode_12."+APPRIS.VERSION+".dump.gz";
APPRIS.MYSQL_FILE_S = "appris.spade.homo_sapiens_gencode_12."+APPRIS.VERSION+".dump.gz";
APPRIS.MYSQL_FILE_I = "appris.inertia.homo_sapiens_gencode_12."+APPRIS.VERSION+".dump.gz";
APPRIS.MYSQL_FILE_X = "appris.cexonic.homo_sapiens_gencode_12."+APPRIS.VERSION+".dump.gz";
APPRIS.MYSQL_FILE_T = "appris.thump.homo_sapiens_gencode_12."+APPRIS.VERSION+".dump.gz";
APPRIS.MYSQL_FILE_R = "appris.crash.homo_sapiens_gencode_12."+APPRIS.VERSION+".dump.gz";
APPRIS.MYSQL_FILE_A = "appris.pi.homo_sapiens_gencode_12."+APPRIS.VERSION+".dump.gz";
...
/* 
 * CONSTANTS: Agent panels 
 */
APPRIS.TOOL_DATA_SEQUENCE_PANEL = new Array();
APPRIS.TOOL_DATA_SEQUENCE_PANEL['url'] =  APPRIS.RESTWS_URL+"agent/blastp";
APPRIS.TOOL_DATA_SEQUENCE_PANEL['url2'] =  APPRIS.RESTWS_URL+"agent/muscle";
...
<ul>\
	...
	<li><span class='content_highlighting'>APPRIS-Gencode 7</span>, Dec 2012: <a href='../gencode7/' class='linkPage'>http://appris.bioinfo.cnio.es/archives/gencode7/</a></li>\
</ul>\
\
\
\
