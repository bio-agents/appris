...
- thump
	...
	Phobius (http://www.ebi.ac.uk/Agents/phobius/).
	
	E.g.
		http://appris.bioinfo.cnio.es/ws/rest/thump/id/ENSG00000099904
		http://appris.bioinfo.cnio.es/ws/rest/thump/name/CRISP3
		http://appris.bioinfo.cnio.es/ws/rest/thump/id/ENST00000334554
		http://appris.bioinfo.cnio.es/ws/rest/thump/name/OTTHUMT00000040871
		http://appris.bioinfo.cnio.es/ws/rest/thump/name/CCDS4929
